...
public final class HUD {
    ...
    public static func show(content: HUDContentType,dimsBackground:Bool) {
    ...
    //新加的不同需求
    public static func showProgressHud(dimsBackground:Bool) {
        self.dimsBackground = dimsBackground
        PKHUD.sharedHUD.contentView = contentView(.Progress)
        PKHUD.sharedHUD.show()
    }
