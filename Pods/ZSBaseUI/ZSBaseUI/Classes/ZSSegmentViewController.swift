...
public protocol ZSSegmentProtocol {
    func segmentViewControllers() ->[UIViewController]
}

open class ZSSegmentViewController: UIViewController ,UICollectionViewDelegate{

    
    open var delegate:ZSSegmentProtocol?
    private var collectionView:UICollectionView!
    
    open var scrollViewDidEndDeceleratingHandler:ZSSegmentHandler?
