...
class RootNavigationView: UIView {
    ...
    static func  make(delegate:UIViewController,leftAction:Selector,rightAction:Selector){
        ...
        leftBtn.setBackgroundImage(UIImage(named: "nav_home_side_menu"), for: UIControl.State())
        ...
        rightBtn.setBackgroundImage(UIImage(named: "nav_add_book"), for: UIControl.State())
