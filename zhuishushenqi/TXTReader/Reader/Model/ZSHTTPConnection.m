...
NSString *const ZSHTTPConnectionUploadFileFinished = @"kUploadFileFinished";
...
@interface ZSHTTPConnection()<MultipartFormDataParserDelegate>

@end

@implementation ZSHTTPConnection
...
- (void)processContent:(NSData *)data WithHeader:(MultipartMessageHeader *)header {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ZSHTTPConnectionUploadFileFinished object:nil userInfo:field.params];
    if (storeFile) {
