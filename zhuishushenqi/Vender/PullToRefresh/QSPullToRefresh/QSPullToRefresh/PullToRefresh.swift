...
open class PullToRefresh: NSObject {
    ...
    public convenience init(height: CGFloat = 40, position: Position = .top,tip:String) {
        
        let refreshView = DefaultRefreshView(frame:CGRect(x: 0, y: 0, width: 0, height: 0) , tip: tip)
