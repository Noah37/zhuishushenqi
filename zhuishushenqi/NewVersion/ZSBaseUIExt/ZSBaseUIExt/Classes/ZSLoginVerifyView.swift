...
public typealias ZSLoginVerifyViewResultHandler = (_ ret:Int, _ param:[String:String]) ->Void

public class ZSLoginVerifyView: UIView, UIWebViewDelegate {

    public var webView:UIWebView!
    public var backgroundView:UIView!
    
    public var resultHandler:ZSLoginVerifyViewResultHandler?
    ...
    public func startVerify(str:String) {
