...
public typealias ZSLoginHandler = ()->Void

public class ZSLoginView: UIView {
    ...
    public var loginHandler:ZSLoginHandler?
    public var getSMSCodeHandler:ZSLoginHandler?
    ...
    public func smsCodeText() ->String {
        return verifyNumTextField.text ?? ""
    }
}


public class ZSLoginTextField: UITextField {
