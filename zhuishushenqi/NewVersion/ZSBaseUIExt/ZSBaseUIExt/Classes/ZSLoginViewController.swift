...
public typealias ZSLoginVCBackHandler = ()->Void
public typealias ZSLoginVCResultHandler = (_ success:Bool)->Void

public let LoginSuccess = "LoginSuccess"

public class ZSLoginViewController: BaseViewController {
    ...
    public var loginVerifyView:ZSLoginVerifyView!
    ...
    public override func popAction() {
        backHandler?()
        super.popAction()
    }
