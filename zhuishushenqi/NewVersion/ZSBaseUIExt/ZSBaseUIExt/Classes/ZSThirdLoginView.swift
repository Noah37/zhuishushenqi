...
public typealias ZSThirdLoginHandler = (_ type:ThirdLoginType)->Void
public typealias ZSThirdLoginCloseHandler = ()->Void

public class ZSThirdLoginView: UIView {
    
    public var leftLineLabel:UILabel!
    public var rightLineLabel:UILabel!
    public var loginTypeLabel:UILabel!
    public var qqLoginButton:UIButton!
    public var wxLoginButton:UIButton!
    public var wbLoginButton:UIButton!
    public var xmLoginButton:UIButton!
    public var userProtocolButton:UIButton!
    public var closeButton:UIButton!
    
    public var thirdLoginHandler:ZSThirdLoginHandler?
    public var closeHandler:ZSThirdLoginCloseHandler?
    public var userProtocolHandler:ZSThirdLoginCloseHandler?
