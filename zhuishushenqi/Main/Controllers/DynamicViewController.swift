...
class DynamicViewController: BaseViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        title = "动态"
        tableView.register(UINib(nibName: "DynamicCell", bundle: nil), forCellReuseIdentifier: "DynamicCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:DynamicCell = tableView.dequeueReusableCell(withIdentifier: "DynamicCell",for: indexPath) as! DynamicCell
        return cell
    }
