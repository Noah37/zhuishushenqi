...
class CategoryViewController: BaseViewController ,UITableViewDataSource,UITableViewDelegate,CategoryCellItemDelegate{
    
    var id:String? = ""
    var books:NSMutableArray? = NSMutableArray()
    fileprivate let iden = "CategoryCell"
...
//        let types = ["new","hot","reputation","over"]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:CategoryCell? = tableView.dequeueReusableCell(withIdentifier: iden,for: indexPath) as? CategoryCell
