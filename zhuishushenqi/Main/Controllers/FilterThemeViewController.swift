...
class FilterThemeViewController: BaseViewController,UITableViewDataSource,UITableViewDelegate,FilterThemeCellDelegate {
    ...
    fileprivate lazy var tableView:UITableView = {
        ...
        tableView.register(FilterThemeCell.self, forCellReuseIdentifier: self.iden)
        return tableView
    }()
...
//       http://api.zhuishushenqi.com/book-list/tagType
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:FilterThemeCell? = tableView.dequeueReusableCell(withIdentifier: iden,for: indexPath) as? FilterThemeCell
